...
public class SVM extends ForecastAlgorithm {
    public ForecastAlgorithm run(String givenDate, int testSize, String fileName){
        ...
        System.out.println("\n\nPrzewidywanie SVM na podstawie zebranych "+trainSize+" danych:");
        ...
        //wartosci predukowanych ma byc tyle ile wynosi test_size
